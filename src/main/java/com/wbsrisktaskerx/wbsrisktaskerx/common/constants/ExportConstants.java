...
public class ExportConstants {
    ...
    public static final String PURCHASE_HISTORY_CUSTOMER = "PurchaseHistory_Customer_";
    public static final String WARRANTY_HISTORY_CUSTOMER = "WarrantyHistory_Customer_";
    public static final String XLSX = ".xlsx";
    public static final String DATE_TIME = "dd_MM_yyyy";
    ...
    public static final String FILENAME_FORMAT = "%s%s%s";
}